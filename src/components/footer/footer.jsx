...
function Footer() {
  return (
    ...
    >
      <section className="cbc-container">
        ...
        <div className="footerWrapper">
          ...
          <div className="socialLinks">
            <h4 className="c-underline">FOLLOW US</h4>
            <ul className="social-icons-list">
              {/* Facebook */}
              <li>
                <a
                  href="https://www.facebook.com/people/Calvary-Bible-Church/61572481437691/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <svg
